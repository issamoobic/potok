...
- [ ] Проверить реквизиты оператора персональных данных в разделе "Контакты"
- [ ] Проверить, что обе галочки в форме работают (152-ФЗ обязательная, 38-ФЗ опциональная)

## Что доделать после первых лидов

- Подключить счётчик аналитики
- Проверить и актуализировать кейсы в `src/components/Cases.astro`
...
1. Лид с формы → почта, при необходимости обезличенное уведомление в Telegram
